...
class ImageZoomShareButtonWidget extends StatelessWidget {
  final ImageZoomController controller;

  const ImageZoomShareButtonWidget({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return BaseBlocBuilder<bool>(
      ...
      onSuccessWidget: (_) => IconButton(
        ...
        tooltip: Translate.s.share_image,
